  ...
  return (
    <section className="py-16 relative overflow-hidden bg-gradient-to-b from-background to-background/50">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Interactive Roadmap - Compact Version */}
        <div className="mb-8">
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              {/* Horizontal Roadmap */}
              <div className="flex items-center justify-center overflow-x-auto pb-2">
                <div className="flex items-center gap-3 sm:gap-4 md:gap-6 min-w-max px-4">
                  {/* Step 1 */}
                  <div 
                    className="group cursor-pointer flex flex-col items-center"
                    onClick={() => document.getElementById('app-showcase')?.scrollIntoView({ behavior: 'smooth' })}
                  >
                    <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-primary to-secondary rounded-full flex items-center justify-center text-primary-foreground font-bold text-sm sm:text-base shadow-md hover:scale-110 transition-transform duration-300 mb-1">
                      1
                    </div>
