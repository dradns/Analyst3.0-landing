      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto">
            По итогам курса вы получаете полностью функциональное мини-приложение GigaMentor с персональным AI-ментором, настроенным под вашу специализацию и готовым для использования в работе.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
            Все функции приложения будут полностью настроены и готовы к работе: персонализированные ответы, база знаний, история диалогов и автоматические уведомления.
          </p>
        </div>
      </div>
    </section>
