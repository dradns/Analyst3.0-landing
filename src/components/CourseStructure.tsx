...
const CourseStructure = ({ openModuleId, onOpenModule }: CourseStructureProps = {}) => {
  ...
  const courseModules = [
    ...
    },
    {
      ...
      description: "Создайте визуальные макеты для вашего AI-агента. Это поможет понять, как будет выглядеть интерфейс и как пользователь будет взаимодействовать с системой. Перед началом урока обязательно посмотрите видеолекции от команды создателей курса. Ссылки на youtube-канал находятся внизу каждого раздела.",
      tasks: [
    ...
    },
    {
      ...
      description: "Создайте BPMN диаграмму или Activity diagram для вашего AI-агента. Это поможет понять логику работы системы и последовательность действий. Перед началом урока обязательно посмотрите видеолекции от команды создателей курса. Ссылки на youtube-канал находятся внизу каждого раздела.",
      tasks: [
    ...
    },
    {
      ...
      description: "Спроектируйте архитектуру вашего AI-агента. Определите, как будут взаимодействовать фронтенд, бэкенд и база данных. Перед началом урока обязательно посмотрите видеолекции от команды создателей курса. Ссылки на youtube-канал находятся внизу каждого раздела.",
      tasks: [
    ...
    },
    {
      ...
      description: "Создайте ERD-диаграмму для вашего AI-агента. Определите, какие данные будут храниться и как они связаны между собой. Перед началом урока обязательно посмотрите видеолекции от команды создателей курса. Ссылки на youtube-канал находятся внизу каждого раздела.",
      tasks: [
    ...
    },
    {
      ...
      description: "Создайте UML диаграмму последовательности для вашего AI-агента. Покажите, как различные компоненты системы взаимодействуют во времени. Перед началом урока обязательно посмотрите видеолекции от команды создателей курса. Ссылки на youtube-канал находятся внизу каждого раздела.",
      tasks: [
    ...
    },
    {
      ...
      description: "Опишите REST API для вашего AI-агента в табличном виде. Определите эндпоинты, методы и параметры. Перед началом урока обязательно посмотрите видеолекции от команды создателей курса. Ссылки на youtube-канал находятся внизу каждого раздела.",
      tasks: [
    ...
    },
    {
      ...
      description: "Создайте Swagger документацию для вашего API. Это поможет другим разработчикам понять, как использовать вашу систему. Перед началом урока обязательно посмотрите видеолекции от команды создателей курса. Ссылки на youtube-канал находятся внизу каждого раздела.",
      tasks: [
    ...
    },
    {
      ...
      description: "Сформулируйте критерии приемки и нефункциональные требования для вашего AI-агента. Это поможет понять, когда проект можно считать завершенным. Перед началом урока обязательно посмотрите видеолекции от команды создателей курса. Ссылки на youtube-канал находятся внизу каждого раздела.",
      tasks: [
    ...
    },
    {
      ...
      description: "Создайте работающий AI-агент и разверните его. Это финальный этап, где вы применяете все полученные знания. Перед началом урока обязательно посмотрите видеолекции от команды создателей курса. Ссылки на youtube-канал находятся внизу каждого раздела.",
      tasks: [
