            ...
            <div className="text-left animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row items-start gap-6 mb-8">
                ...
                <div className="relative group animate-scale-in">
                  ...
                  <button
                    className="relative inline-flex items-center justify-center gap-3 h-20 px-12 py-6 text-2xl font-bold rounded-2xl bg-gradient-to-r from-primary/90 to-secondary/90 text-primary-foreground hover:from-primary hover:to-secondary hover:scale-105 active:scale-95 transition-all duration-300 shadow-2xl hover:shadow-glow group hover-lift"
                  >
                    <span className="flex items-center gap-3">
                      Начать первый урок
                      <Rocket className="w-7 h-7 group-hover:translate-y-[-2px] group-hover:rotate-12 transition-transform duration-300" />
                    </span>
                  </button>
                </div>
              </div>
