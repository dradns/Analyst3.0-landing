...
const translations = {
  ru: {
    ...
    'hero.homework.text': 'Изучите каждый блок курса и начните практику в аналитике нового поколения уже сегодня',
...
как демонстрация ваших навыков.`,
    ...
    'students.roadmap.title': 'Проекты выпускников курса',
    'students.main.title': 'Наши студенты создали своих AI-агентов',
    'students.subtitle': 'Результат обучения на курсе "Системный Аналитик 3.0":',
    'students.description': 'посмотрите презентации и видеоролики готовых ИИ-агентов, созданных нашими учениками с нуля за 12 недель',
    'students.watch.video': 'Смотреть проморолик',
    'students.open.presentation': 'Открыть презентацию',
    'students.menu.title': 'Работы студентов',
    'students.click.to.view': 'Нажмите для просмотра',
    
    // Student Projects Data
    'students.project.1.name': 'Артем',
    'students.project.1.title': 'AI-агент блогера',
    'students.project.1.description': 'Бот, который помогает авторам каналов создавать новые посты на основе анализа истории публикаций',
    'students.project.2.name': 'Диана',
    'students.project.2.title': 'AI-агент AI-Neiry',
    'students.project.2.description': 'Бот анализирует сигналы мозга и подсказывает, когда именно вы на пике продуктивности, а когда нужен отдых',
    'students.project.3.name': 'Иван',
    'students.project.3.title': 'AI-агент AI-Book',
    'students.project.3.description': 'Бот, который составляет для пользователя персональную подробку книг на основе его предпочтений',
    'students.project.4.name': 'Екатерина',
    'students.project.4.title': 'AI-агент HedgeAiCare',
    'students.project.4.description': 'Бот помогает владельцам домашних ежей получать экспертные консультации по содержанию, питанию и гигиене',
    'students.project.5.name': 'Ильнур',
    'students.project.5.title': 'AI-агент INVEST Checker US',
    'students.project.5.description': 'Бот помогает анализировать User Stories по критериям INVEST для улучшения качества разработки',
    'students.project.6.name': 'Ира',
    'students.project.6.title': 'AI-планировщик событий',
    'students.project.6.description': 'Бот является персональным планировщиком событий, который помогает пользователям планировать свои задачи и цели',
    'students.project.7.name': 'Рудольф',
    'students.project.7.title': 'AI-агент Marketing AI Bot',
    'students.project.7.description': 'Бот анализирует информацию из CRM системы и дает рекомендации по маркетинговым улучшениям',
    'students.project.8.name': 'Карина',
    'students.project.8.title': 'AI-интеллектуальный ассистент поддержки',
    'students.project.8.description': 'Бот трансформирует ваш клиентский сервис, делая его быстрым, персонализированным и эффективным 24/7',
    'students.project.9.name': 'Руслан',
    'students.project.9.title': 'AI-агент Birthday reminder bot',
    'students.project.9.description': 'Бот, который не просто напоминает о днях рождения, а создаёт тексты поздравлений и предлагает идеи для подарков',
    'students.project.10.name': 'Лилия',
    'students.project.10.title': 'AI-агент Calendar bot',
    'students.project.10.description': 'Бот, который понимает естественный язык и управляет вашим календарём - просто пишите боту свои задачи как человеку',
    'students.project.11.name': 'Виталий',
    'students.project.11.title': 'AI-анализ чатов на Авито PRO',
    'students.project.11.description': 'Бот предназначен для владельцев бизнеса на Авито, чтобы контролировать качество обслуживания клиентов',
    'students.project.12.name': 'Тамара',
    'students.project.12.title': 'AI-советчик SocioMind bot',
    'students.project.12.description': 'Бот предлагает последовательно ответить на 8 вопросов, после чего выдаёт ваш тип личности',
    'students.project.13.name': 'Марина',
    'students.project.13.title': 'AI-тренер GymAiMentor',
    'students.project.13.description': 'Бот персональный-тренер в Telegram, который создает программы под ваши цели и отвечает на любые вопросы о фитнесе',
...
as demonstration of your skills.`,
    ...
    // Student Projects Section
    'students.roadmap.title': 'Graduate Projects',
    'students.main.title': 'Our Students Created Their Own AI Agents',
    'students.subtitle': 'Result of training in the "System Analyst 3.0" course:',
    'students.description': 'watch presentations and videos of ready-made AI agents created by our students from scratch in 12 weeks',
    'students.watch.video': 'Watch Promo',
    'students.open.presentation': 'Open Presentation',
    'students.menu.title': 'Student Projects',
    'students.click.to.view': 'Click to view',
    
    // Student Projects Data
    'students.project.1.name': 'Artem',
    'students.project.1.title': 'AI Blogger Agent',
    'students.project.1.description': 'Bot that helps channel authors create new posts based on publication history analysis',
    'students.project.2.name': 'Diana',
    'students.project.2.title': 'AI-Neiry Agent',
    'students.project.2.description': 'Bot analyzes brain signals and tells you when you are at peak productivity and when you need rest',
    'students.project.3.name': 'Ivan',
    'students.project.3.title': 'AI-Book Agent',
    'students.project.3.description': 'Bot that creates personalized book selections based on user preferences',
    'students.project.4.name': 'Ekaterina',
    'students.project.4.title': 'HedgeAiCare AI Agent',
    'students.project.4.description': 'Bot helps hedgehog owners get expert advice on care, nutrition and hygiene',
    'students.project.5.name': 'Ilnur',
    'students.project.5.title': 'INVEST Checker US AI Agent',
    'students.project.5.description': 'Bot helps analyze User Stories by INVEST criteria to improve development quality',
    'students.project.6.name': 'Ira',
    'students.project.6.title': 'AI Event Planner',
    'students.project.6.description': 'Bot is a personal event planner that helps users plan their tasks and goals',
    'students.project.7.name': 'Rudolf',
    'students.project.7.title': 'Marketing AI Bot Agent',
    'students.project.7.description': 'Bot analyzes information from CRM system and provides marketing improvement recommendations',
    'students.project.8.name': 'Karina',
    'students.project.8.title': 'AI Intelligent Support Assistant',
    'students.project.8.description': 'Bot transforms your customer service, making it fast, personalized and efficient 24/7',
    'students.project.9.name': 'Ruslan',
    'students.project.9.title': 'Birthday Reminder AI Bot',
    'students.project.9.description': 'Bot that not only reminds about birthdays, but creates greeting texts and suggests gift ideas',
    'students.project.10.name': 'Liliya',
    'students.project.10.title': 'Calendar AI Bot',
    'students.project.10.description': 'Bot that understands natural language and manages your calendar - just write your tasks to the bot like to a person',
    'students.project.11.name': 'Vitaliy',
    'students.project.11.title': 'AI Chat Analysis for Avito PRO',
    'students.project.11.description': 'Bot designed for Avito business owners to monitor customer service quality',
    'students.project.12.name': 'Tamara',
    'students.project.12.title': 'SocioMind AI Advisor Bot',
    'students.project.12.description': 'Bot offers to answer 8 questions sequentially, after which it reveals your personality type',
    'students.project.13.name': 'Marina',
    'students.project.13.title': 'GymAiMentor AI Trainer',
    'students.project.13.description': 'Personal trainer bot in Telegram that creates programs for your goals and answers any fitness questions',
