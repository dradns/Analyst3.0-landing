...
const translations = {
  ru: {
    ...
    'modes.ba.features.2': 'Прототипирование интерфейсов (от скетчей до интерактивных макетов)',
  ...
  en: {
    ...
    'modes.ba.features.2': 'Interface prototyping (from sketches to interactive mockups)',
