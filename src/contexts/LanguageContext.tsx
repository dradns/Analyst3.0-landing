...
const translations = {
  ru: {
    ...
    'hero.mode.ba.description': 'User Stories, User Cases, прототипирование интерфейсов, BPMN, Activity diagram',
  ...
  en: {
    ...
    'hero.mode.ba.description': 'User Stories, User Cases, interface prototyping, BPMN, Activity diagram',
